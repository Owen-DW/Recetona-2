...
// verifica cada campo sea distinto de vacio y cumpla con las validaciones (en el segundo if)
...
formulario.addEventListener('submit', (e) => {
    if (!validarCampoVacioEnFormulario() || !validarEmail() || !validarContrasena()) {
        e.preventDefault(); // aca se previene el envío si algun campo no es válido
    }
});
